...
class FlutterLocationPicker extends StatefulWidget {
  ...
  const FlutterLocationPicker({
    ...
    this.mapLanguage = 'en',
    this.selectLocationButtonText = 'انتخاب مکان',
    this.mapAnimationDuration = const Duration(milliseconds:100 ),
    this.trackMyPosition = false,
    this.showZoomController = true,
    this.showLocationController = false,
    ...
    this.searchBarHintText = 'جستجوی مکان',
